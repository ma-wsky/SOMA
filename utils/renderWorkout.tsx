...
import type {ExerciseSet, OverlayTypes, Workout} from "@/types/workoutTypes";
import {workoutStyles as styles} from "@/styles/workoutStyles";
import {newStyles, NumberStepper} from "@/components/NumberStepper";
...
export const renderActiveOverlays = (props: ActiveWorkoutRenderProps): React.ReactNode => {
    ...
    const isFromActiveWorkout = props.isFromActiveWorkout !== false;
                            ...
                            {isBreaktime ? (
                                    ...
                                    <View style={newStyles.timeInputContainer}>
                                        <View style={{alignItems: 'center'}}>
                                            ...
                                            <TextInput
                                                ...
                                                onChangeText={(v) => props.onSetTempBreakTime({
                                                    ...props.tempBreakTime,
                                                    mins: v === "" ? null : Number(v)
                                                })}
                                            />
                                        </View>
                                        <Text style={{
                                ...
                                <View style={{paddingHorizontal: 20, paddingTop: 20}}>
                                    ...
                                    <View style={{marginBottom: 24}}>
                                        <Text style={{color: Colors.black, fontSize: 16, marginBottom: 8}}>Gewicht
                                            (kg)</Text>
                                        <NumberStepper
                                            label=""
                                    ...
                                    {isFromActiveWorkout && (
                                        <View style={{
                                            ...
                                            <Pressable
                                                onPress={() => props.onSetTempSetData({
                                                    ...props.tempSetData,
                                                    isDone: !props.tempSetData.isDone
                                                })}
                                            >
                                                <Ionicons
