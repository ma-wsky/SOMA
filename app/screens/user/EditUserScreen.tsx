...
import {cancelAllNotifications, scheduleWeeklyWorkoutReminder} from "@/utils/helper/notificationHelper";
                        ...
                        <View style={userStyles.editUserContainer}>
                            ...
                            <View style={userStyles.layout}>
                                ...
                                <Text style={[userStyles.text, {
                                    marginLeft: 30,
                                    marginTop: 10
                                }]}>Trainingserinnerung</Text>

                                <EditRow
                                    label="Uhrzeit"
                                    value={formData.reminderTime.toLocaleTimeString([], {
                                        hour: '2-digit',
                                        minute: '2-digit'
                                    })}
                                    isPressable
