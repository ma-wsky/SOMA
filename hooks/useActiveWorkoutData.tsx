...
import {showAlert, showChoice, showConfirm} from "@/utils/helper/alertHelper";
...
import {clearWorkoutTimer} from "@/utils/store/workoutTimerStore"
import {clearRestTimer} from "@/utils/store/restTimerStore"
import {clearEditingWorkout} from "@/utils/store/workoutEditingStore"
    ...
    const handleDiscardWorkout = useCallback(() => {
        showConfirm(
            ...
            () => {
                ...
                clearWorkoutTimer();
                clearRestTimer();
                if (editIdRef.current) clearEditingWorkout(editIdRef.current);
