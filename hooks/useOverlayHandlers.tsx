...
import {secondsToMinSec} from "@/components/NumberStepper";
...
export const useOverlayHandlers = () => {
    ...
    const [tempSetData, setTempSetData] = useState<{
        weight: number | null;
        reps: number | null;
        isDone?: boolean
    }>({weight: null, reps: null, isDone: false});
    const [tempBreakTime, setTempBreakTime] = useState<{ mins: number | null; secs: number | null }>({
        mins: null,
        secs: null
    });
